...
class posts{
    ...
    static function edit($p){
        ...
        $r['edit']=bj(icovoc('update','modif'),'content|posts,update|id='.$a.'|petitle,pecategory,peexcerpt,pecontent','btsav');
    ...
    static function form($p){
        ...
        $ret.=bj(voc('send'),'content|posts,save||cat,tit,exc,msg','btsav');
    ...
    static function read($p){
        ...
        $r['edit']=auth(4)?bh(icovoc('edit','edit'),'post/'.$a.'/edit',''):'';
        $ret=view::call('blocks/post',$r);
        return $ret;
    }
