...
$ret.=div(input('name','').label('name',voc('knowname')));
$ret.=div(inpsw('pswd','').label('pswd',voc('password')));
return $ret;}
...
if($ok){self::identify($uid); $ret=div(voc('loged').', '.$a,'frame-green');}
elseif($uid){
